...
class RemConfigSettings(models.TransientModel):
    ...
    module_website_residential = fields.Boolean('Install Real Estate Website', help="By checking this option you "
                                                                                    "will be installing the Real Estate Website on the front-end of your system.")
    group_use_buyer_contracts = fields.Boolean('Use Buyer Representations Agreements',
                                               implied_group='rem.group_use_buyer_contracts',
